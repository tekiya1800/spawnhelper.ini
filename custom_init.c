...
void main()
{
	...
	weather.GetOvercast().SetForecastChangeLimits( 0.0, 0.5 );
	...
	weather.GetOvercast().SetForecastTimeLimits( 600 , 3000 );
	...
	weather.GetOvercast().Set( Math.RandomFloatInclusive(0.0, 0.6), 1, 0);
